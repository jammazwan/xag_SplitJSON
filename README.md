...
Functionality: **_Different options for splitting a body with JSON content_**
...
_run XagTest to explore the options. NOTES.md is the actual doc on this project._
...
so you can focus only on what is required to demo the **SplitJSON** feature **_in isolation_**.
...
The prefix **xag** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
